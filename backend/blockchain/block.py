...
class Block:
    ...
    def mine_block(last_block, data):
        ...
        a block hass is found that meets the leading zero's proof
        of work requirement.
        """
    ...
    def adjust_difficulty(last_block, new_timestamp):
        '''
        Calculate the adjusted difficulty according to the mine rate;
        increase difficulty for quickly mined blocks; decrase
        difficulty for slowly mined blocks.
        '''
